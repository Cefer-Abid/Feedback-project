    ...
    <div className="empty--content">
      <div className="empty__logo-div">
        <svg width="102" height="108" xmlns="http://www.w3.org/2000/svg">
          <g fillule="nonzero" fill="none" opacity=".5">
            <path
      ...
      <div className="content__text--div">
        <div className="text--div">
          <h2 className="empty--title">There is no feedback yet.</h2>
          <div>
        ...
        <div className="empty__btn-div">
          {/* <Link to="/new-feedback" className="empty__btn--feedback btn">
            + Add Feedback
          </Link> */}
