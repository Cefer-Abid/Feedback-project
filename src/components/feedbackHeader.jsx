...
function FeedbackHeader() {
  const { productRequests } = useContext(AppContext);

  return (
    <div className="header-div">
      <div className="header header__suggestions">
        ...
        <div className="suggestions--text">
          <span className="suggestions--count">{productRequests.length}</span>{" "}
          <span>Suggestions</span>
        </div>
        
        <div className="header header__sort">
          <HeaderSort />
        </div>
      </div>

      {/* <Link className="btn--add-feedback" to="/new-feedback">
        + Add Feedback
      </Link> */}
